...
function bindModelSettingsTabsV95(){document.querySelectorAll('[data-model-settings-tab-v95]').forEach(button=>button.onclick=()=>activateModelSettingsTabV95(button.dataset.modelSettingsTabV95))}
