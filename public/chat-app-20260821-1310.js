...
function injectFunctionModelStatusStylesV94(){if($('functionModelStatusStylesV94'))return;document.head.insertAdjacentHTML('beforeend','<style id="functionModelStatusStylesV94">.function-model-status-v94{display:flex;align-items:flex-start;gap:9px;padding:8px 0}.function-model-status-v94+.function-model-status-v94{border-top:1px solid color-mix(in srgb,var(--chat-border) 72%,transparent)}.function-model-status-v94 i{width:8px;height:8px;flex:none;margin-top:5px;border-radius:50%;background:#9aa1a4}.function-model-status-v94.normal i{background:#4eaf76}.function-model-status-v94.error i{background:#d65c5c}.function-model-status-v94 strong{display:block;color:var(--chat-text);font:600 13px var(--font-b)}.function-model-status-v94 p{margin:3px 0 0;color:var(--chat-muted);font:12px/1.45 var(--font-b);word-break:break-word}.field small{display:block;margin-top:5px;color:var(--chat-muted);font:11px/1.4 var(--font-b)}#leftDrawer .nav-action[data-panel="models"]{position:relative}#leftDrawer .nav-action[data-panel="models"].has-model-status-alert-v94:after{content:"";width:7px;height:7px;margin-left:auto;border-radius:50%;background:#d65c5c;box-shadow:0 0 0 2px var(--chat-surface)}html[data-appearance="dark"] .function-model-status-v94+.function-model-status-v94{border-top-color:#3A3A3A}html[data-appearance="dark"] .function-model-status-v94 strong{color:#F2F2F2}html[data-appearance="dark"] .function-model-status-v94 p{color:#B0B0B0}html[data-appearance="dark"] #leftDrawer .nav-action[data-panel="models"].has-model-status-alert-v94:after{box-shadow:0 0 0 2px #262626}</style>')}
